...
# 
# # Part 1: Extract and Clean AQI & Weather Data from API
# By Nam Aaron Nguyen
# ![Hanoi%20data-4.jpg](attachment:Hanoi%20data-4.jpg)
...
#Code: a17ac515f9b6411393c923e7abd376f5
url = "https://api.weatherbit.io/v2.0/history/airquality?city=Hanoi&start_date=2024-02-08&end_date=2024-03-08&tz=local&key=a17ac515f9b6411393c923e7abd376f5"
url2 = "https://api.weatherbit.io/v2.0/history/airquality?city=Hanoi&start_date=2024-01-08&end_date=2024-02-08&tz=local&key=a17ac515f9b6411393c923e7abd376f5"
...
url12 = "https://api.weatherbit.io/v2.0/history/airquality?city=Hanoi&start_date=2023-03-08&end_date=2023-04-08&tz=local&key=a17ac515f9b6411393c923e7abd376f5"


# Due to the API's limitation of 800 historical data points per request, which corresponds to 800 hourly data values, I will specify 12 separate URL (equivalent to 12 months, 720 data points each request) to obtain hourly AQI data from 08/03/2023 to 08/03/2024.
...
# To retrieve the data in a readable format, I will parse each  into JSON. I will delve into the variable "results" as an example to see the keys and values in the JSON
# 
...
# The values of "data" key in the variable "results" span from 00:00:00 08/02/2024 to 00:00:00 08/03/2024. After scrutinizing the JSON, we know which key to use. Therefore, we will move on to the next part joining 12 data "keys" from 12 variables.
...
# In this section, I combined the "data" values from 12 different variables. As a result, the values of "data" key from new created variable "joined_results" span from from 00:00:00 08/03/2023 to 00:00:00 08/03/2024 (a span of one year).
